...
function Hero() {
  ...
  const items = ['Windows', 'Linux', 'servidores', 'estações'];
    ...
    <section className="hero">
      ...
      <div className="hero__inner">
        <div className="hero__badge">
          ...
          Open Source RMM — .NET 10 · MIT License
        </div>

        <h1 className="hero__title">
          Gerencie endpoints com{' '}
          <span className="hero__gradient-text">velocidade</span>{' '}
          e{' '}
          <span className="hero__gradient-text">controle total</span>
        </h1>

        <p className="hero__subtitle">
          DiscoveryRMM é um servidor open source de Remote Monitoring & Management
          que oferece visibilidade completa sobre seus{' '}
